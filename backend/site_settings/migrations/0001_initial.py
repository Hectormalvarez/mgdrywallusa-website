            ...
            state_operations=[
                migrations.CreateModel(
                    ...
                    fields=[
                        ...
                        ("license_number", models.CharField(blank=True, default="", help_text="State contractor license number", max_length=100)),
                        ...
                        ("auto_responder_subject", models.CharField(default="Thank you for contacting MG Drywall USA", max_length=255)),
                        ("auto_responder_message", models.TextField(default="Hi {name},\n\nThank you for your quote request.")),
                        ("banner_enabled", models.BooleanField(default=False)),
                        ("banner_text", models.CharField(blank=True, default="Free on-site estimates for all residential projects!", max_length=255)),
                ...
                migrations.CreateModel(
                    ...
                    fields=[
                        ...
                        ("setting", modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name="navigation_items", to="site_settings.sitesettings")),
                    ],
                    options={
                        "abstract": False,
